...
<div className="max-w-7xl mx-auto px-6 md:px-16 py-16 flex flex-col md:flex-row items-center gap-8 md:min-h-[400px]">
  ...
  <a href="https://twitter.com" target="_blank" rel="noreferrer" aria-label="Twitter">
    <FaTwitter size={24} className="text-[#252B42] hover:text-blue-400 transition-colors" />
  </a>
  <a href="https://facebook.com" target="_blank" rel="noreferrer" aria-label="Facebook">
    <FaFacebook size={24} className="text-[#252B42] hover:text-blue-600 transition-colors" />
  </a>
  <a href="https://instagram.com" target="_blank" rel="noreferrer" aria-label="Instagram">
    <FaInstagram size={24} className="text-[#252B42] hover:text-pink-500 transition-colors" />
  </a>
  <a href="https://linkedin.com" target="_blank" rel="noreferrer" aria-label="LinkedIn">
    <FaLinkedin size={24} className="text-[#252B42] hover:text-blue-700 transition-colors" />
  </a>
</div>
  </div>
